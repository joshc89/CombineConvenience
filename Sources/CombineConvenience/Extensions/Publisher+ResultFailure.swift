...
extension Publisher {
    ...
    public typealias CaughtResult = Publishers.Catch<Publishers.Map<Self, Result<Self.Output, Self.Failure>>, Just<Result<Self.Output, Self.Failure>>>
    ...
    public func catchByResult() -> CaughtResult {
...
extension Publisher where Failure == Never {
    ...
    public func promotingFailure<O, F>() -> Publishers.TryMap<Self, O> where Output == Result<O, F> {
